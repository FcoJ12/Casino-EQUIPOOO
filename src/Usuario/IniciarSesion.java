...
public class IniciarSesion extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(puedeInc){
            new JFrame_Principal("Menú Principal",Entrar.VentanaEntrar.uM.getUsuarioActual().getSaldo(),Entrar.VentanaEntrar.uM.getUsuarioActual().getPremios(),Entrar.VentanaEntrar.uM.getUsuarioActual().getNickname()).setVisible(true);
