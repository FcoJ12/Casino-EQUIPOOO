...
public class RegistrarSesion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Usuario/ImagenesUsuario/RuletaPremios.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        boolean noExiste=Entrar.VentanaEntrar.uM.crearUsuario(jTextField3.getText(),jTextField2.getText(),jTextField1.getText());
        if(noExiste){
            Entrar.VentanaEntrar.setVisible(true);
            this.setVisible(false);
        } else {
