 ...
 * @author Murat
 */
public class RegistrarSesion extends javax.swing.JFrame {

    UserManagement uM;
    
    /**
     * Creates new form RegistrarSesion
     */
    public RegistrarSesion(UserManagement uM) {
        this.uM = uM;
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        boolean noExiste=uM.crearUsuario(jTextField3.getText(),jTextField1.getText(),jTextField2.getText());
        if(noExiste){
            Entrar.VentanaEntrar.setVisible(true);
            this.setVisible(false);
        } else {
